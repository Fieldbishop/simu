...
public class Tapahtuma implements Comparable<Tapahtuma> {
	...
	private double aika;
	private TapahtumanTyyppi päämäärä;
	
	public Tapahtuma(TapahtumanTyyppi tyyppi, double aika){
		this.tyyppi = tyyppi;
		this.aika = aika;
	}
	public Tapahtuma(TapahtumanTyyppi tyyppi, double aika, TapahtumanTyyppi päämäärä){
		this.tyyppi = tyyppi;
		this.aika = aika;
		this.päämäärä = päämäärä;
	}
	
	
	public TapahtumanTyyppi getPäämäärä() {
		return päämäärä;
	}
