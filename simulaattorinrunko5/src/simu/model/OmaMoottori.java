...
public class OmaMoottori extends Moottori {
	...
	protected void alustukset() {
		...
		kontrolleri.setSaliTekstit(Paikka.SALI1, Double.toString(salit[0].getAlkamisAika()),
				Double.toString(salit[0].getLoppuAika()));
		kontrolleri.setSaliTekstit(Paikka.SALI2, Double.toString(salit[1].getAlkamisAika()),
				Double.toString(salit[1].getLoppuAika()));
		...
		for (Asiakas a : asiakasRekisteri) {
			...
			case SALIDEP1:
				...
				sali1TotalPalveluAika += a.getPoistuminen(TapahtumanTyyppi.SALIDEP1)
						- a.getSaapumisaika(TapahtumanTyyppi.SALIDEP1);
				break;
			case SALIDEP2:
				sali2Total++;
				sali2TotalPalveluAika += a.getPoistuminen(TapahtumanTyyppi.SALIDEP2)
						- a.getSaapumisaika(TapahtumanTyyppi.SALIDEP2);
				break;
			default:
				break;
			}
